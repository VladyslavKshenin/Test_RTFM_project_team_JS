import{a as p,b as $,c as d,d as T,l as x}from"./assets/applebooks@2x-32274212.js";const y="/Test_RTFM_project_team_JS/assets/books-desk@1x-1f62c9bc.png",S="/Test_RTFM_project_team_JS/assets/books-desk@2x-306b4264.png",v="/Test_RTFM_project_team_JS/assets/books-mob@1x-93df6442.png",a="shoppingCard",i="shoppingList",o=document.querySelector(".js-shopping-list"),c=document.querySelector(".shopping-list-container"),L="The daughter of a Korean mother and Jewish American father, and leader of the indie rock project Japanese Breakfast, describes creating her own identity after losing her mother to cancer.",n=l(a),g=l(i);n[0]!==void 0?(c.innerHTML="",o.innerHTML="",o.insertAdjacentHTML("afterbegin",m(n)),o.addEventListener("click",M)):f();function M(s){let e=s.target.closest(".btn-shop");if(e)o.innerHTML="",n.splice(e.id,1),g.splice(e.id,1),localStorage.removeItem(a),localStorage.removeItem(i),h(a,n),h(i,g),n[0]!==void 0?o.insertAdjacentHTML("afterbegin",m(l(a))):f();else return}function m(s){return s.map(({book_image:e,title:t,author:b,description:r,amazonLinks:u,appleLinks:k},_)=>(r||(r=L),`<li class="shopping-list-item">
        ...
        <div class="shopping-list-card-bottom-container">
          ...
          <div class="shopping-list-card-container-img">
            ...
            <a href="${k}" class="shopping-book-link" rel="noopener noreferrer nofollow" target="_blank">
              <img class="shopping-list-card-icon-book" srcset="${d} 1x, ${T} 2x" src="${d}" alt="Apple books" loading="lazy">
            </a>
          </div>
        </div>
        <div>
          <button class="btn-shop shopping-list-card-container-trash" id="${_}">
