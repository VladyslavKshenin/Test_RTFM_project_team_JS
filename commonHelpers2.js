import{a as i,b as f,c as d,d as g,l as h}from"./assets/applebooks@2x-9bf15c24.js";const m="/Test_RTFM_project_team_JS/assets/books-desk@1x-1f62c9bc.png",u="/Test_RTFM_project_team_JS/assets/books-desk@2x-306b4264.png",b="/Test_RTFM_project_team_JS/assets/books-mob@1x-93df6442.png",k=[{sebel:"sdfsdfsdf",sdfss:"sdfsdfsdf",fdsdfsdfsdf:"sdfsdf"},{sebel:"sdfsdfsdf",sdfss:"sdfsdfsdf",fdsdfsdfsdf:"sdfsdf"},{sebel:"sdfsdfsdf",sdfss:"sdfsdfsdf",fdsdfsdfsdf:"sdfsdf"}];localStorage.setItem("localCard",JSON.stringify(k));const r="localCard",o=document.querySelector(".js-shopping-list"),n=document.querySelector(".shopping-list-container"),a=p(r);a[0]!==void 0?(n.innerHTML="",o.innerHTML="",o.insertAdjacentHTML("afterbegin",l(a)),o.addEventListener("click",v)):c();function v(s){if(s.target.nodeName==="BUTTON"||s.target.nodeName==="svg"||s.target.nodeName==="use")o.innerHTML="",a.splice(s.target.id,1),localStorage.removeItem(r),y(r,a),a[0]!==void 0?o.insertAdjacentHTML("afterbegin",l(p(r))):c();else return}function l(s){return s.map(({sebel:e},t)=>`<li class="shopping-list-item">
